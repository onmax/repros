...
Without the patch, the verifier prints `HTTP 500; text/html;charset=utf-8; missing` and exits with an assertion error before the JSON check.

## Fix

The patch carries a sanitized error cause through Nuxt's internal development error-page request.
