...
This directory is the **patched control**. [The other side](../vueuse-storage-redundant-serialization/README.md) has identical application and verifier code. Metadata selects the expected counts; only the fixed side applies a pnpm patch.
