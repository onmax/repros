# Nuxt Icon remote collection downloads: baseline
...
The patched comparison is [the sibling fixture](../nuxt-icon-perf-remote-collection-dedup-fix/README.md). This directory installs the unmodified published package.
