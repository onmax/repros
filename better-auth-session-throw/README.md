...
Reproduction branch: `repro/better-auth-session-throw`. Clone with `git clone --branch repro/better-auth-session-throw --single-branch https://github.com/onmax/repros.git`, then enter this fixture directory. The sibling fixed fixture uses the same command.
