...
<template>
  <div class="shell">
    <header class="topbar">
      <div>
        <p class="eyebrow">
          Better Auth `#319` repro
        </p>
        <h1>SSR-safe store forwarding for `useUserSession()`</h1>
      </div>
    ...
    <section class="card">
      ...
      <dl class="grid">
        ...
        <div>
          <dt>Expected before fix</dt>
          <dd>SSR crashes while Pinia inspects `signIn`</dd>
        </div>
        <div>
          <dt>Expected after fix</dt>
          <dd>Page renders and store exposes auth actions safely</dd>
        </div>
      </dl>
    </section>
