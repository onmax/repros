...
`pnpm verify --expect-fixed` asserts the desired behavior. It fails here at 4,950 versus 0 comparisons for 100 pages. Both sibling fixtures contain the same verifier.
...
Use the sibling `nuxt-content-navigation-scan-fix` fixture for the pnpm patch comparison.
