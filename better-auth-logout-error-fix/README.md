# Better Auth logout error fixed control
...
Reproduction branch: `repro/better-auth-logout-error`. Clone with `git clone --branch repro/better-auth-logout-error --single-branch https://github.com/onmax/repros.git`, then enter this fixture directory. The sibling failing fixture uses the same command.
